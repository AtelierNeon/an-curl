...
echo "[Linux] Project information: CURL with disabled apps: $PROJECT_CURL_WITH_DISABLED_APPS"
echo "[Linux] Project information: CURL with shared libraries: $PROJECT_CURL_WITH_SHARED_LIBRARIES"
echo "[Linux] Project information: CURL with shared Zlib: $PROJECT_CURL_WITH_SHARED_ZLIB"
echo "[Linux] Project information: CURL with sibling SSL: $PROJECT_CURL_WITH_SIBLING_SSL"
echo "[Linux] Project information: CURL with sibling Zlib: $PROJECT_CURL_WITH_SIBLING_ZLIB"
