...
echo "[$SYSTEM_PLATFORM] Project information: CURL with OpenSSL: $PROJECT_CURL_WITH_OPENSSL"
...
echo "[$SYSTEM_PLATFORM] Project information: CURL with Zlib: $PROJECT_CURL_WITH_ZLIB"
