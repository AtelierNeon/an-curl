...
PROJECT_CURL_WITH_DISABLED_APPS="${MY_PROJECT_CURL_WITH_DISABLED_APPS:=OFF}"
...
PROJECT_CURL_WITH_SIBLING_SSL="${MY_PROJECT_CURL_WITH_SIBLING_SSL:=OFF}"
PROJECT_CURL_WITH_SIBLING_ZLIB="${MY_PROJECT_CURL_WITH_SIBLING_ZLIB:=OFF}"
...
if [ "ON" = "$PROJECT_CURL_WITH_DISABLED_APPS" ]; then
    MY_CMAKE_COMMON_ARGUMENT_LIST+=("-DCURL_WITH_DISABLED_APPS=$PROJECT_CURL_WITH_DISABLED_APPS")
fi
...
if [ "ON" = "$PROJECT_CURL_WITH_SIBLING_SSL" ]; then
    MY_CMAKE_COMMON_ARGUMENT_LIST+=("-DCURL_WITH_SIBLING_SSL=$PROJECT_CURL_WITH_SIBLING_SSL")
fi
if [ "ON" = "$PROJECT_CURL_WITH_SIBLING_ZLIB" ]; then
    MY_CMAKE_COMMON_ARGUMENT_LIST+=("-DCURL_WITH_SIBLING_ZLIB=$PROJECT_CURL_WITH_SIBLING_ZLIB")
fi
...
echo "[$SYSTEM_PLATFORM] Project information: CURL with disabled apps: $PROJECT_CURL_WITH_DISABLED_APPS"
echo "[$SYSTEM_PLATFORM] Project information: CURL with shared libraries: $PROJECT_CURL_WITH_SHARED_LIBRARIES"
echo "[$SYSTEM_PLATFORM] Project information: CURL with shared Zlib: $PROJECT_CURL_WITH_SHARED_ZLIB"
echo "[$SYSTEM_PLATFORM] Project information: CURL with sibling SSL: $PROJECT_CURL_WITH_SIBLING_SSL"
echo "[$SYSTEM_PLATFORM] Project information: CURL with sibling Zlib: $PROJECT_CURL_WITH_SIBLING_ZLIB"
